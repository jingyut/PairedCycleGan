...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='paired_cycle_gan', help='chooses which model to use.')
        ...
        parser.add_argument('--netG', type=str, default='resnet_3blocks', help='specify generator architecture ')
